...
class AddPetDetailScreen extends StatefulWidget {
  const AddPetDetailScreen({Key? key}) : super(key: key);

  @override
  State<AddPetDetailScreen> createState() => _AddPetDetailScreenState();
}
...
class _AddPetDetailScreenState extends State<AddPetDetailScreen> {
  ...
  final TextEditingController uploadidNumController = TextEditingController();
  ...
  signup1() async {
    try {
      ...
      var request = http.MultipartRequest(
          'POST', Uri.parse('https://petfinder.booksica.in/pet/addpet'));
      request.fields.addAll({
        'userId': '${BaseClient.box2.read("user_id")}',
        'name': nameController.text,
        'breed': breedController.text,
        'gender': genderController.text,
        'vaccineName': vacciaNameController.text.isEmpty?"":vacciaNameController.text,
        ...
        'dob': dobController.text,
        'vaccineDate': vaccinDateController.text.isEmpty?"":vaccinDateController.text,
        'RFIDNo': uploadidNumController.text,
      ...
      if (response.statusCode == 200) {
        ...
        print(
            "===============data2===========$data2===============================");
        print("response data2 $data2");
        var data1 = jsonDecode(data2);
                      ...
                      children: [
                        ...
                        Expanded(
                          child: MyTextFormField(
                            ...
                            controller: uploadidNumController,
                            validate: (value) {
                              if (value!.isEmpty) {
                                return "RFID number required";
                              } else {
                                return null;
                              }
                            },
                    ...
                    uploadidNameController.text.isNotEmpty
                        ? Padding(
                            ...
                            child: Text(
                              ...
                              style:
                                  Texttheme.title.copyWith(color: Colors.blue),
                            ),
                          )
                        : SizedBox(),
                    const SizedBox(
