...
import 'package:petapp/app/routes/app_pages.dart';
...
class OtpViewTwo extends StatefulWidget {
  const OtpViewTwo({Key? key}) : super(key: key);

  @override
  State<OtpViewTwo> createState() => _OtpViewState();
}

class _OtpViewState extends State<OtpViewTwo> {
